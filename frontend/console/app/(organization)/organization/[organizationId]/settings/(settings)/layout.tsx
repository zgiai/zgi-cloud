...
export default function Layout({ children }: { children: React.ReactNode }) {
    ...
    const sidebarItems = [
        {
            group: organizationLang[language].organizationSettings,
            items: [
                {
                    href: `/organization/${organizationId}/settings/settings`,
                    label: organizationLang[language].settings,
                ...
                // {
                //   href: `/organization/${organizationId}/settings/create`,
                //   label: "New Project",
    ...
    return (
        <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-[96rem] mx-auto">
            ...
            <div className="mb-8">
                {/* Title */}
                <h1 className="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">{organizationLang[language].organizationSettings}</h1>
            </div>
            {/* Content */}
